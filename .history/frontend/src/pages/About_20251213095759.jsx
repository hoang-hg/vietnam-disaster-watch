  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
       ...
       <div className="mt-3 text-gray-700 leading-relaxed">
        Viet Disaster Watch là hệ thống tổng hợp tin thiên tai từ 12 nguồn báo chính thống, tự động phân loại và nhóm thành Sự kiện.
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
         <div className="rounded-2xl border border-gray-300 bg-white p-4">
           ...
           <ul className="mt-2 text-sm text-gray-700 list-disc pl-5 space-y-1">
            <li>Ưu tiên RSS; fallback Google News RSS theo domain (site:... + từ khóa).</li>
         ...
         <div className="rounded-2xl border border-gray-300 bg-white p-4">
           ...
           <ul className="mt-2 text-sm text-gray-700 list-disc pl-5 space-y-1">
            <li>NLP nâng cao (PhoBERT/VnCoreNLP) cho trích xuất chính xác hơn.</li>
            <li>Admin dashboard để duyệt/điều chỉnh sự kiện.</li>
            <li>Push notification (web push / Zalo OA) theo khu vực người dùng.</li>
          </ul>
        </div>
      </div>
    </div>

        ...
        {events.map((e) => (
          ...
          >
            ...
            <div className="mt-3 flex flex-wrap gap-2 text-sm">
              ...
              {e.injured ? (
                <div className="bg-yellow-50 text-yellow-800 px-2 py-1 rounded">
                  Bị thương: {e.injured}
                </div>
              ) : null}
              {e.missing ? (
              ...
              {e.damage_billion_vnd ? (
                <div className="bg-gray-50 text-gray-900 px-2 py-1 rounded">
                  Ước thiệt hại: {fmtVndBillion(e.damage_billion_vnd)}
                </div>
              ) : null}
            </div>

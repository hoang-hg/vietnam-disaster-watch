...
export default function Dashboard() {
  ...
  async function load() {
    try {
      setError(null);
      const dateParam = selectedDate ? `&date=${selectedDate}` : `&hours=${hours}`;

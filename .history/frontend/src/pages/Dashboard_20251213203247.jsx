  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-6">
        ...
        <StatCard
          title="Bão/ATNĐ (24h)"
          value={stats?.by_type?.storm ?? "—"}
          sub="Tin bão mới"
        />
        <StatCard
          title="Mưa lũ (24h)"
          value={stats?.by_type?.flood ?? "—"}
          sub="Tin lũ/ngập mới"
        />
        <StatCard
          title="Sạt lở (24h)"
          value={stats?.by_type?.landslide ?? "—"}
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-4">
        <StatCard
          title="Động đất (24h)"
          value={stats?.by_type?.earthquake ?? "—"}
          sub="Tin động đất mới"
        />
        <StatCard
          title="Sóng thần (24h)"
          value={stats?.by_type?.tsunami ?? "—"}
          sub="Tin sóng thần mới"
        />
        <StatCard
          title="Gió mạnh (24h)"
          value={stats?.by_type?.wind_hail ?? "—"}
          sub="Tin gió mạnh/dông lốc"
        />
        <StatCard
          title="Cháy rừng (24h)"
          value={stats?.by_type?.wildfire ?? "—"}
          sub="Tin cháy rừng mới"
        />
        <StatCard
          title="Khí hậu cực đoan (24h)"
          value={stats?.by_type?.extreme_weather ?? "—"}

    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
        <div className="rounded-2xl border border-gray-300 bg-white p-4 shadow-sm">
          <div className="text-xs text-gray-600 font-medium">Chết</div>
          <div className="text-2xl font-bold mt-2 text-gray-900">
            {ev.deaths ?? "—"}
          </div>
        </div>
        <div className="rounded-2xl border border-gray-300 bg-white p-4 shadow-sm">
          <div className="text-xs text-gray-600 font-medium">Mất tích</div>
          <div className="text-2xl font-bold mt-2 text-gray-900">
            {ev.missing ?? "—"}
          </div>
        </div>
        <div className="rounded-2xl border border-gray-300 bg-white p-4 shadow-sm">
          <div className="text-xs text-gray-600 font-medium">Bị thương</div>
          <div className="text-2xl font-bold mt-2 text-gray-900">
            {ev.injured ?? "—"}
          </div>
        </div>
        <div className="rounded-2xl border border-gray-300 bg-white p-4 shadow-sm">
          <div className="text-xs text-gray-600 font-medium">Thiệt hại</div>
          <div className="text-2xl font-bold mt-2 text-gray-900">
            {fmtVndBillion(ev.damage_billion_vnd)}
          </div>
        </div>
      </div>

  ...
  if (error) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-8">
        <div className="rounded-2xl border border-rose-800 bg-rose-900/20 p-4 text-rose-200">{error}</div>
      </div>
    )
  }
  if (!ev) return <div className="mx-auto max-w-4xl px-4 py-8 text-slate-400">Đang tải…</div>

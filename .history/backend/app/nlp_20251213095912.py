...
RE_DEATHS = re.compile(r"(\d[\d\.\,]*)\s*người\s*chết", re.IGNORECASE)
RE_MISSING = re.compile(r"(\d[\d\.\,]*)\s*người\s*mất\s*tích", re.IGNORECASE)
RE_INJURED = re.compile(r"(\d[\d\.\,]*)\s*người\s*bị\s*thương", re.IGNORECASE)
RE_DAMAGE = re.compile(r"(\d[\d\.\,]*)\s*(tỉ|tỷ)\s*đồng", re.IGNORECASE)

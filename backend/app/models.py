...
class Article(Base):
    ...
    is_broken: Mapped[bool] = mapped_column(Boolean, default=False, index=True) # 0=no, 1=yes/broken
    ...
    __table_args__ = (
        ...
        Index("ix_article_source_published", source, published_at),
        Index("ix_article_domain_published", domain, published_at),
    )
